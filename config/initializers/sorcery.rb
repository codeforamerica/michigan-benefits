...
Rails.application.config.sorcery.submodules = [:reset_password, :remember_me, :session_timeout, :brute_force_protection, :activity_logging, :external]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.reset_password_mailer = AccountsMailer
    ...
    # Default: `nil`
    #
    user.reset_password_expiration_period = 12.hours
