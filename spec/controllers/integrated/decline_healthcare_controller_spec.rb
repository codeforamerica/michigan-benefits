    ...
    context "when FAP only" do
      it "returns true" do
        application = create(:common_application,
                             navigator: create(:application_navigator, applying_for_healthcare: false, applying_for_food: true))
    ...
    context "when FAP and MA" do
      context "when anyone applying for healthcare" do
        it "returns true" do
          ...
          navigator: create(:application_navigator, applying_for_healthcare: true, applying_for_food: true))
