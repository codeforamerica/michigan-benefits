  ...
  describe "#update" do
    context "with valid params" do
      ...
      it "updates the models" do
        ...
        expect(current_app.primary_member.student_yes?).to eq(true)
      end
    end
  end
end
