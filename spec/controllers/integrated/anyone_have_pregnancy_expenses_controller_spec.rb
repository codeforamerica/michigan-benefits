...
RSpec.describe Integrated::AnyoneHavePregnancyExpensesController do
  describe "#skip?" do
    context "when single member household" do
      it "returns true" do
        application = create(:common_application, :single_member)

        skip_step = Integrated::AnyoneHavePregnancyExpensesController.skip?(application)
  ...
  describe "#update" do
    context "when true" do
      let(:valid_params) do
        {
          anyone_pregnancy_expenses: "true",
        }
      end
      ...
      it "updates the application navigator" do
        ...
        expect do
          ...
          current_app.reload
          current_app.navigator.anyone_pregnancy_expenses?
        }.to eq(true)
      end
    end
    ...
    context "when false" do
      let(:valid_params) do
        {
          anyone_pregnancy_expenses: "false",
        }
      end
