...
RSpec.describe Integrated::AnyoneDisabledController do
  describe "#skip?" do
    context "when single member household" do
      it "returns true" do
        application = create(:common_application, :single_member)

        skip_step = Integrated::AnyoneDisabledController.skip?(application)
  ...
  describe "#update" do
    context "when true" do
      ...
      it "updates the application navigator" do
        ...
        expect do
          ...
          current_app.reload
          current_app.navigator.anyone_disabled?
        }.to eq(true)
      end
    end
    ...
    context "when false" do
      ...
      it "updates the application navigator and household members" do
        ...
        expect(current_app.navigator.anyone_disabled?).to be_falsey
        expect(current_app.primary_member.disabled_no?).to be_truthy
      end
    end
  end
end
