...
class Views::Steps::Show < Views::Base
  ...
  def question_field(f, question, label_text, label_option)
    ...
    group_classes += ' form-group--error' if f.object.errors[question].present?
    ...
    div class: group_classes,
      ...
      p step.overview(question) if step.overview(question)
      ...
      safety step.safety(question) if step.safety(question)
    end
  end
end
